...
const FinalAnggaranStep = ({ data, documentId, refreshData }) => {
  ...
  const handleSubmit = async () => {
    ...
    if (!formData.jenis_pembelanjaan || !formData.item) {
      alert("Jenis and item wajib diisi");
      return;
    }
  ...
  return (
    <div className="step-container">
      <div className="step-header d-flex justify-content-between align-items-end">
        <div>
          <h2 className="step-title">Anggaran</h2>
          <p className="step-subtitle">Data anggaran untuk laporan akhir penelitian.</p>
        </div>
      ...
      <div className="form-card mt-3">
        <h3 className="form-card-title">
          <i className={`bi ${editingId ? "bi-pencil-square" : "bi-cash-stack"}`}></i> 
...
export default FinalAnggaranStep;