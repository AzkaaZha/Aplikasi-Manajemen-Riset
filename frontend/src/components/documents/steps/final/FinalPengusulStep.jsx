...
const FinalPengusulStep = ({ data, documentId, refreshData }) => {
  ...
  return (
    <div className="step-container">
      <div className="step-header">
        ...
        <p className="step-subtitle">Kelola daftar ketua dan anggota peneliti untuk laporan akhir.</p>
      </div>
...
export default FinalPengusulStep;
