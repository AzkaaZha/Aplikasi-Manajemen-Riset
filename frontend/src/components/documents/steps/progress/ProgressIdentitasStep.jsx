...
const ProgressIdentitasStep = ({ data, onChange }) => {
  const readonlyFields = [
    ...
    { type: "text", name: "tema_penelitian", label: "Tema Penelitian" },
    { type: "text", name: "topik_penelitian", label: "Topik Penelitian" },
    { type: "text", name: "rumpun_bidang_ilmu", label: "Rumpun Bidang Ilmu" },
    { type: "text", name: "target_akhir_tkt", label: "Target Akhir TKT" },
...
export default ProgressIdentitasStep;
