...
const ProgressLampiranStep = ({ data, documentId, refreshData }) => {
  ...
  return (
    <div className="step-container">
      <div className="step-header">
        <h2 className="step-title">Lampiran & Dokumen Pendukung</h2>
        <p className="step-subtitle">Unggah dokumen pendukung untuk laporan kemajuan Anda.</p>
      </div>
        ...
        <div className="row g-3">
          <div className="col-md-6">
            ...
            <input 
              ...
              placeholder="Contoh: Bukti Kehadiran Seminar"
              value={formData.nama}
          ...
          <div className="col-12">
            ...
            <textarea 
              ...
              className="form-control" 
              rows="2"
              placeholder="Tambahkan catatan singkat tentang file ini..."
...
export default ProgressLampiranStep;
