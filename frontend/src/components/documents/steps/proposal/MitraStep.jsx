...
const MitraStep = ({ data, documentId, refreshData }) => {
  ...
  const fields = [
    ...
    { type: "textarea", name: "alamat", label: "Alamat Mitra", placeholder: "Alamat lengkap mitra atau instansi" },
    { type: "textarea", name: "keterangan", label: "Keterangan Kontribusi", placeholder: "Uraian kontribusi atau peran mitra dalam penelitian" },
  ];
  ...
  return (
    <div className="step-container">
      <div className="step-header">
        ...
        <p className="step-subtitle">Kelola daftar instansi atau individu yang menjadi mitra penelitian.</p>
      </div>
