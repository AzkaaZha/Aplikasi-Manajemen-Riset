...
const ProposalLampiranStep = ({ data, documentId, refreshData }) => {
  ...
  const tipeOptions = [
    "PDF", "JPG", "PNG", "Dokumen Pendukung", "CV Peneliti", 
    "Surat Pernyataan", "RAB Detail", "Lainnya"
  ];
  ...
  return (
    <div className="step-container">
      <div className="step-header">
        <h2 className="step-title">Lampiran Proposal</h2>
        <p className="step-subtitle">Unggah dokumen pendukung untuk proposal penelitian Anda.</p>
      </div>
        ...
        <div className="row g-3">
          <div className="col-md-6">
            ...
            <input 
              ...
              placeholder="Contoh: CV Ketua Peneliti"
              value={formData.nama}
      ...
      <div className="step-header mt-5">
        <h3 className="step-title fs-5">Daftar Lampiran</h3>
      </div>
        ...
        <table className="custom-table">
          ...
          <tbody>
            {lampiranList.length === 0 ? (
              <tr><td colSpan="4" className="text-center py-4 text-muted">Belum ada lampiran.</td></tr>
            ) : (
              lampiranList.map((l) => (
                <tr key={l.id}>
                  <td>
...
export default ProposalLampiranStep;
