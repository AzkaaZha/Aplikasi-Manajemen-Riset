...
const FinalLuaranStep = ({ data, documentId, refreshData }) => {
  ...
  return (
    <div className="step-container">
      <div className="step-header">
        ...
        <p className="step-subtitle">Kelola data luaran penelitian dan status target capaian untuk laporan akhir.</p>
      </div>

      <div className="form-card">
        <h3 className="form-card-title">
          <i className="bi bi-trophy"></i> Tambah Target Luaran
        </h3>
        <div className="row">
          {fields.map((field) => (
...
export default FinalLuaranStep;
