const ProgressSelesaiStep = ({ onExport, isExporting }) => {
  return (
    <div className="step-container text-center py-5">
      ...
      <p className="step-subtitle fs-5 mx-auto mb-5 max-w-600">
        Anda telah melengkapi semua langkah yang diperlukan untuk laporan kemajuan ini. 
...
export default ProgressSelesaiStep;
