    ...
    <div className="login-page">
      <div className="login-card">
        ...
        <div className="login-header">
          ...
          <p className="text-muted small">Sign in to manage research system</p>
        </div>
        ...
        <div className="login-footer">
          <small className="text-muted">
            Need access? <a href="#" className="text-success fw-bold text-decoration-none">Contact Admin</a>
          </small>
        </div>
      </div>
    </div>
